...
class TTSDataset(Dataset):
    ...
    def get_energy(self, idx):
        ...
        # print(item["audio_unique_name"], out_dict["audio_unique_name"])
...
####
    def __getitem__(self, idx):
        ...
        # print(string2filename(item["audio_unique_name"]))
        # assert False
    ...
    @staticmethod
    def create_energy_file_path(file_name,cache_path):   #wav_file, 
